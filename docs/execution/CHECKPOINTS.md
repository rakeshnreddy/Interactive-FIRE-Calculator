...
| C09B | Delivery hygiene, App extraction, flagship FIRE correction | B37 → B39 → B36 | released | — | [B37 start prompt](prompts/B37.md); C09 hosted residual must be observed before B37 acceptance |
