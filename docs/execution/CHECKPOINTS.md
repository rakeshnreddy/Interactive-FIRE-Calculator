...
| C09 | Saved decision and monthly review | B10 → B11 → B28 | released; B10 accepted, B11/B28 rework | — | [latest review](reviews/C09-hosted-attempt-7467116.md) · [focused worker prompt](C09_HOSTED_LOCATOR_FINISH_PROMPT.md) |
