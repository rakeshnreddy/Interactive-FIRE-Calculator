...
1. Upgrade income, tax, budget, and protection calculators with clearer waterfalls, period tables where useful, statutory-estimate assumptions, cashflow mapping, emergency runway, and protection-gap visuals.
2. Deepen India tax old/new regime and salary take-home assumptions without claiming filing-grade precision.
3. Deepen US paycheck/income-tax assumptions with filing-status/pay-frequency architecture and clear estimate labels.
4. Keep detailed tables collapsed and optional by default, matching the Phase 21/22 UI pattern.
...
Current status:
Phases 1 and 3 through 22 are complete for preview/development. Phase 12 adds reviewed transaction CSV imports, Phases 13-16 plus Phase 18 add the public calculator library, Phase 19 completed calculator UX/formula assurance, Phase 17 adds durable calculator-to-account saves plus signed-out draft preservation, Phase 20 adds decision-studio metadata, scenario state, chart primitives, examples, related calculators, and guard tests, Phase 21 adds expandable optional schedule/detail tables for growth, goal, retirement, withdrawal, distribution, benefit, inflation, and return calculators, and Phase 22 adds borrowing-route expansion plus amortization/payoff/refinance/prepayment/detail schedules, custom period views, CSV export, and multi-debt strategy comparison. Phase 23-25 calculator value/visualization upgrades are tracked in `docs/CALCULATOR_VALUE_ROADMAP.md`. Phase 2 still has one launch blocker: Clerk needs a production instance/domain and production keys.

Next goal:
Either complete production Clerk setup for launch readiness or begin Phase 23 Income, Tax, Budget, and Protection Deepening. Phase 23 should deepen gross-to-net waterfalls, estimate assumptions, cashflow/category visuals, emergency runway, and protection-gap planning. Keep Clerk production auth/domain setup as a launch blocker.
...
## Detailed Phase 23 Handoff Prompt
